...
export default function Portfolio() {
  ...
  const projects = [
    ...
    { title: 'Risk Management Dashboard', description: 'Dashboard untuk manajemen risiko PT Aero Systems Indonesia (ASYST) berbasis web dengan fitur visualisasi data menggunakan Laravel dan Chart.js', link: 'https://github.com/DevinmuhB/RiskMGTDashboard', image: '/assets/projects/riskdash.png' }
  ];
